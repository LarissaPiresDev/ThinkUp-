...
import com.example.myapplication.Questoes1AnoActivitys.PrimeiraSerieQuestao003Activity
import com.example.myapplication.R

class SegundaSerieQuestao001Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.segunda_serie_questao001)
        ...
        alternativa1.setOnClickListener {
            ...
            Handler(Looper.getMainLooper()).postDelayed({
                val intent = Intent(this, SegundaSerieQuestao002Activity::class.java)
