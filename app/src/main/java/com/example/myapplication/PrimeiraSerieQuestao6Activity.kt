...
class PrimeiraSerieQuestao6Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.primeira_serie_questao6)
        ...
        alternativa1.setOnClickListener {
            ...
            Handler(Looper.getMainLooper()).postDelayed({
                val intent = Intent(this, PrimeiraSerieQuestao7Activity::class.java)
